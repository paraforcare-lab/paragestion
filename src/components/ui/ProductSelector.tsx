...
const ProductCard = ({
  ...
  return (
    <button
      ...
      disabled={outOfStock}
      className={cn(
        "w-full p-3 rounded-[6px] border-2 text-left transition-all duration-200",
        "flex gap-3 items-stretch",
        selected
          ? "border-emerald-500 bg-emerald-50/30 shadow-none"
        ...
        <DialogHeader className="px-6 py-4 border-b border-border/50 flex-shrink-0">
          ...
          <div className="mt-4 relative">
            ...
            <Input
              ...
              className="pl-11 h-10 bg-white border-slate-200 rounded-[4px] focus:border-slate-300 shadow-none text-sm"
            />
            {searchTerm && (
              <button
                type="button"
          ...
          <div className="space-y-2">
            {filteredProduits.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                <div className="bg-slate-50 rounded-[6px] p-4 mb-3">
          ...
          <div className="border-t border-slate-100 p-4 flex-shrink-0 bg-slate-50/50">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className="bg-emerald-500 hover:bg-emerald-600 text-white font-semibold h-10 px-6 rounded-[4px] shadow-none"
              >
