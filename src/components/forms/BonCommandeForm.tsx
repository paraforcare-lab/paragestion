    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
      <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            <Label className="text-slate-700 font-semibold">Date de livraison prévue</Label>
            <Input type="date" className="bg-white border-slate-300" {...form.register('dateLivraisonPrevue')} />
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between border-b pb-2">
          <h3 className="text-lg font-bold text-slate-800">Lignes de commande</h3>
          <Button
            type="button"
            variant="outline"
            size="sm"
        ...
        <div className="w-full md:w-80">
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 space-y-4 shadow-sm">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-2xl font-black text-orange-600">{formatCurrency(totals.ttc)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end items-center space-x-4 pt-6 border-t">
        ...
        <Button type="submit" disabled={isLoading} className="bg-orange-600 hover:bg-orange-700 text-white px-8 h-11 font-bold shadow-lg shadow-orange-100">
