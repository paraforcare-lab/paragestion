  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        {isEntreprise && (
          <div className="space-y-4 p-4 rounded-2xl bg-gradient-to-r from-purple-500/5 to-transparent border border-purple-200/50">
            <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
        ...
        <div className="flex justify-end pt-6 border-t border-border/50">
          <Button 
            ...
            className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-bold px-8 h-12 rounded-xl shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300"
          >
