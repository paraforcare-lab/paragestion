  ...
  const fetchPrescriptions = async () => {
    ...
    try {
      ...
      const mapped = (data || []).map((p: any) => ({
        ...p,
        client_nom: p.clients?.nom || `#${p.client_id}`,
      }));
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-b border-slate-100 dark:border-white/5">
              ...
              <TableHead className="text-xs font-semibold text-slate-500 uppercase tracking-wider dark:text-slate-400">OD/OG</TableHead>
